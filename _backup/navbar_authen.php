...
<nav class="navbar navbar-inverse" role="navigation">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <!-- แสดงชื่อผู้ใช้งาน -->
            <p class="navbar-text navbar-right">ล็อกอิน <a href="_login_update.php" target="_blank" class="navbar-link"  style="color: white;"><?= "[" . $loginResult["user_id"] . "] " . $loginResult["name"] . "</a> (" . $_SESSION["status"] . ") &nbsp;" ?></p>
