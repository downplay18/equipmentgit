...
<script src="js/datatables/extensions/Buttons/js/buttons.bootstrap.min.js" type="text/javascript"></script>
<script src="js/datatables/extensions/Buttons/js/buttons.colVis.min.js" type="text/javascript"></script>