<div class="list-group">
    ...
    <a href="<?= $root_url ?>/show.php" class="list-group-item"><span class="glyphicon glyphicon-search"></span> สืบค้น(ซื้อปกติ)<span class="badge">999</span></a>
    <a href="<?= $root_url ?>/show_urgent.php" class="list-group-item"><span class="glyphicon glyphicon-search"></span> สืบค้น(ซื้อเร่งด่วน)<span class="badge">999</span></a>
