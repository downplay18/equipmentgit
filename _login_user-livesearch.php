    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="page-header">
                <h2>รายการหลัก <small>ของ <?= $_SESSION["name"] ?></small></h2>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4" align="left">
                    <a class="btn btn-danger" href="take.php" target="_blank"><span class="glyphicon glyphicon-minus-sign"></span> เบิกใช้งาน</a>
                </div>
            ...
            $qstatement = "SELECT * FROM `item_slip`";
